...
namespace DesafioAPI.Requests.Tarefas
{
    public class CadastraTarefaRequest : RequestBase
    {
        ...
        public void SetJsonBody(string resumo,
                               ...
                               string tag)
        {
            jsonBody = File.ReadAllText(GeneralHelpers.ReturnProjectPath() + "Jsons/Mantis/Tarefa/CadastraTarefaJson.json", Encoding.UTF8);
        ...
        public void SetJsonBody(string resumo,
                              ...
                              string projeto)
        {
            jsonBody = File.ReadAllText(GeneralHelpers.ReturnProjectPath() + "Jsons/Mantis/Tarefa/CadastraTarefaMinimalJson.json", Encoding.UTF8);
            jsonBody = jsonBody.Replace("$resumo", resumo);
            jsonBody = jsonBody.Replace("$descricao", descricao);
            jsonBody = jsonBody.Replace("$categoria", categoria);
            jsonBody = jsonBody.Replace("$projeto", projeto);
        ...
        public void SetJsonBody(string resumo,
                              ...
                              string anexo)
        {
            jsonBody = File.ReadAllText(GeneralHelpers.ReturnProjectPath() + "Jsons/Mantis/Tarefa/CadastraTarefaAnexoJson.json", Encoding.UTF8);
            jsonBody = jsonBody.Replace("$resumo", resumo);
            jsonBody = jsonBody.Replace("$descricao", descricao);
            jsonBody = jsonBody.Replace("$categoria", categoria);
            jsonBody = jsonBody.Replace("$projeto", projeto);
